...
def search(query):
    ...
    for i in range(len(users)):
        wf.add_item(uid=users[i].username, title="姓名: " + users[i].name, subtitle="erp: " + users[i].username, valid=True, icon=users[i].avatar_url)
    wf.send_feedback()
